...
import {PjBautagebuchEintrageditorComponent} from "./pj-bautagebuch-eintrageditor.component";
...
@NgModule({
  declarations: [
    ...
    PjBautagebuchEintrageditorComponent
  ],
  exports: [
...
export class PjBautagebuchEintrageditorModule {}
