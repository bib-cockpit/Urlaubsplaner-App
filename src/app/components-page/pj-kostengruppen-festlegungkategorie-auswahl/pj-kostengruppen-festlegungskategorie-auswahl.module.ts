...
import {PjKostengruppenFestlegungskategorieAuswahlComponent} from "./pj-kostengruppen-festlegungskategorie-auswahl.component";
...
@NgModule({
  declarations: [
    ...
    PjKostengruppenFestlegungskategorieAuswahlComponent
  ],
  exports: [
...
export class PjKostengruppenFestlegungskategorieAuswahlModule {}
