...
import {PjPlanungsmatrixeintragEditorComponent} from "./pj-planungsmatrixeintrag-editor.component";
...
@NgModule({
  declarations: [
    ...
    PjPlanungsmatrixeintragEditorComponent
  ],
  exports: [
...
export class PjPlanungsmatrixeintragEditorModule {}
