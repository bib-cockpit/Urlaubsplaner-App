...
import {FiOutlookkontakteAuswahlComponent} from "./fi-outlookkontakte-auswahl.component";

@NgModule({
  declarations: [

    FiOutlookkontakteAuswahlComponent
  ],
  exports: [
...
export class FiOutlookkontakteAuswahlModule {}
