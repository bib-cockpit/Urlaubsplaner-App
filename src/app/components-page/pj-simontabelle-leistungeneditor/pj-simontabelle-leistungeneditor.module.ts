...
import {PjSimontabelleLeistungeneditorComponent} from "./pj-simontabelle-leistungeneditor.component";
...
@NgModule({
  declarations: [
    ...
    PjSimontabelleLeistungeneditorComponent
  ],
  exports: [
...
export class PjSimontabelleLeistungeneditorModule {}
