...
export class CommonRegistrierungPage implements OnInit, OnDestroy {
  ...
  FachbereichClickedHandler() {
    ...
    try {
      ...
      this.Auswahlliste.push({Index: 3, FirstColumn: this.Pool.Fachbereich.HLSE.Bezeichnung,               SecoundColumn: this.Pool.Fachbereich.HLSE.Kuerzel,            Data: this.Pool.Fachbereich.HLS.Key});
      ...
      this.Auswahlliste.push({Index: 9, FirstColumn: this.Pool.Fachbereich.Geschaeftsfuehrung.Bezeichnung, SecoundColumn: this.Pool.Fachbereich.Geschaeftsfuehrung.Kuerzel, Data: this.Pool.Fachbereich.Geschaeftsfuehrung.Key});
      this.Auswahlliste.push({Index: 10, FirstColumn: this.Pool.Fachbereich.Assistenz.Bezeichnung,          SecoundColumn: this.Pool.Fachbereich.Assistenz.Kuerzel,          Data: this.Pool.Fachbereich.Assistenz.Key});
