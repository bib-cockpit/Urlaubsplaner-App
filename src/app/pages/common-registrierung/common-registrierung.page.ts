...
export class CommonRegistrierungPage implements OnInit, OnDestroy {
  ...
  FachbereichClickedHandler() {
    ...
    try {
      ...
      this.Auswahlliste.push({Index: 8, FirstColumn: this.Pool.Fachbereich.Geschaeftsfuehrung.Bezeichnung, SecoundColumn: this.Pool.Fachbereich.Geschaeftsfuehrung.Kuerzel, Data: this.Pool.Fachbereich.Geschaeftsfuehrung.Key});
      this.Auswahlliste.push({Index: 9, FirstColumn: this.Pool.Fachbereich.Assistenz.Bezeichnung,          SecoundColumn: this.Pool.Fachbereich.Assistenz.Kuerzel,          Data: this.Pool.Fachbereich.Assistenz.Key});
